...
| Route implementation progress | 76/76 route-owning Stories implemented                                                                                                                          |
...
| Recorded full Vitest floor    | 19,874 passed, 0 failed, 1,255 files after Story 173.13; focused Story floor 975 passed across 22 files                                                         |
...
10. The exact next `.omx/plans/174.1-prove-bmad-route-ledger-and-omx-plan-parity.md` file, read completely before branch/worktree creation.
...
- exactly 94 canonical Stories = 89 done + 5 backlog;
...
A fresh regex inventory found 139 production files containing direct Tailwind palette classes after excluding tests. This is a candidate classification baseline, not 139 proven violations. It contains active debt, completed Epic 173 owner/shared-boundary surfaces that may still require cleanup or reverification, dead code, registered visualization/brand/overlay exceptions, and false positives.
...
- shipment/supply components whose route-owned work was completed by Stories 173.8–173.13; any surviving shared/dead-code candidate now requires explicit Story 174.2 disposition.

Story 174.2 must persist an explicit manifest classifying every candidate as:

1. active violation;
2. completed route-owner surface requiring reverification only;
3. shared-boundary residue requiring cleanup;
4. dead/unreachable;
...
- [Story 173.13 plan](../.omx/plans/173.13-migrate-supply-detail.md)
- [Story 173.13 implementation artifact](../_bmad-output/implementation-artifacts/173-13-fe-migrate-supply-detail.md)
