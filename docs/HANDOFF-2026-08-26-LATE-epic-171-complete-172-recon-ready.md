...
> **§0 RECONCILED 2026-08-27 (сессии 172.1-172.6)**: 172.1 (#278) · 172.2 (#280) · 172.3 (#282) · 172.4 (#285) · 172.5 (#287) · 172.6 (#289) SHIPPED — полный пол **19 334/0**, NEXT = **172.7 COGS history**. Automation + COGS single+bulk домены мигрированы. Ниже §0 обновлён; §1-§2 исторические.
...
| Метрика | Значение |
|---|---|
| `main` | `42ac0686` (PR #289), дерево чистое, сессионные ветки/worktrees 172.1-172.6 = **0/0/0** |
| Прогресс миграции 166-174 | **60/94** канонических стори |
| Эпики | 166 ✅ · 167 ✅ · 168 ✅ · 170 ✅ (7/7) · 171 ✅ (9/9) · **172 IN PROGRESS (6/17)** · 169 in-progress (чужая lane, §2.4) · 173/174 backlog |
| Полный пол (vitest) | **19 334 / 0** (… → 19 327 → 19 334 [+7 гардов 172.6]) |
...
| **NEXT** | **172.7-FE COGS History** (план `.omx/plans/172.7-*.md`; /cogs/history-дерево; его nav-тесты — известные cold-flake: прогревать dev перед e2e); 172.1-172.6 ✅. ENV: node-26 (PATH-префикс node@24); BE login-троттл 5/hr; zsh word-split — явные пути; depth-N маршруты = N×'..' в гард-резолве |
