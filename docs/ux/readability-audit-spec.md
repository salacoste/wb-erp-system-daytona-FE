...
**Convention:** P0 = cross-cutting / high-impact · P1 = page-specific / significant · P2 = polish. Each item: _problem → fix → where_.
...
**Problem:** pages dump 15–30 metric cards with no hierarchy (dashboard ~31 incl. COGS×3, profit-chain×6). Violates _Progressive Disclosure_ (`front-end-spec.md:64`).
