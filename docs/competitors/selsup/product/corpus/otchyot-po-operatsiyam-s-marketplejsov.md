...
slug: otchyot-po-operatsiyam-s-marketplejsov
source: https://selsup.ru/help/otchyot-po-operatsiyam-s-marketplejsov/
chars: 5722
---
...
- Организации;
- Маркетплейсу;
- Типу операции (_продажи, возвраты, Логистика WB, Сервисы Ozon, штрафы, реклама, хранение, удержания, авансовая оплата за товар без движения_), например, если выбрать Хранение, тогда отобразятся только те товары, по которым были совершены операции по хранению.
...
‎Операции привязаны к товару, если есть связь карточки товара в SelSup с маркетплейсом. Если связи нет, то привязки не будет и SelSup не обнаружит у себя такой товар, в таком случае включите переключатель _**«‎Без карточки»‎**_.\
...
Отчет можно просматривать как в интерфейсе, так и в Excel - файле, чтобы скачать файл, нажмите _**«Скачать в Excel‎»**_.\
...
Для этого в скачанном Excel - файле в колонке «‎Самовыкуп» проставьте _**«‎ДА»**_.‎ ‎
