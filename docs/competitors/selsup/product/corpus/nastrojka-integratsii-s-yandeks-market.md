...
- **Номер кампании = _campaign_id_**
- **ID кабинета = _businnes_id_**
...
При авторизации под аккаунтом пользователя с правами администратора Яндекс.Маркет выдаст ошибку _«У вашего аккаунта нет нужного доступа (аккаунт должен быть Владелец или Администратор) для получения ключа API или неправильно указан ID кабинета или номер компании»_.

_**![](../../out/selsup.ru/_kage/selsup.ru/wp-content/webp-express/webp-images/uploads/2023/03/screenshot_351.png.webp)**_
