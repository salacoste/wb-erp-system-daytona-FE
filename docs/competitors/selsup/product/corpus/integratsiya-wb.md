...
_После завершения интеграции во вкладке [**«Интеграции»**](https://selsup.ru/application/integration/) вместо кнопки **"Настроить"** появится кнопка **"Уже настроено"**. Это означает, что интеграция успешно выполнена для всех ваших организаций._ _Если появляется кнопка **"Частично настроено"**, это значит, что интеграция выполнена не для всех организаций, добавленных в SelSup. Нажмите на эту кнопку, чтобы проверить, с какими организациями интеграция еще не настроена._
