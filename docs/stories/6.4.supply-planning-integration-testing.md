...
- [ ] Happy path test
  ...
  test('Supply Planning page displays data', async ({ page }) => {
    ...
    await expect(page.locator('h1')).toContainText('Планирование поставок');
...
All 18 ACs: ❌ NOT STARTED

### Gate Status

Gate: **FAIL** → `docs/qa/gates/6.4-supply-planning-integration-testing.yml`
