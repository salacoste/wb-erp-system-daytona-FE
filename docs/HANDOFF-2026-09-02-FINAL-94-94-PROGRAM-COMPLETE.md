...
| **SEC-DOC-1**               | **redacted (2026-09-02); ротация — owner** | plaintext-креды в tracked docs                                                                                                                                                                                                                   | FE: оба литерала (stale + live) изъяты, non-echoing скан = 0 (PR #TBD); ротация live-креда + BE-репо (135 stale) + history — owner-запрос `docs/security/SEC-DOC-1-rotation-owner-decision-2026-09-02.md` | артефакт `debt-sec-doc-1-redact-creds.md`                                          |
