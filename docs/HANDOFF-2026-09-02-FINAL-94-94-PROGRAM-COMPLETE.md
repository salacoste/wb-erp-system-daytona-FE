...
| **boundary cat-1**          | in-progress owner-sweep  | 459 → **401** нарушений (волна-1 2026-09-02: financial-summary family 11 файлов/58 сайтов → семантические токены, каждый replacement WCAG-замерен; артефакт `debt-p2-boundary-wave1-finsum.md` с house-rule и харнесс-каноном)                                                                 | волны 2-6 остатка 401 (Margin-семейство, SourceBadge, lib-residue); ratchet ↓ тем же коммитом                  | `shadcn-ui-boundary-classification-manifest.md` + артефакт волны-1                                                 |
