...
| **FE-D9**                   | **RESOLVED (2026-09-02)** | `logApiError` пишет не-2xx тела вкл. секреты                                                                                                                                                                                                                    | redact-слой `redactSensitive` (обе ветки logApiError, PR #TBD); остаточные риски — в артефакте                                 | артефакт `debt-fe-d9-redact-logger.md`                                                          |
| **SEC-DOC-1**               | open                     | plaintext-креды в tracked docs                                                                                                                                                                                                                                  | вычистить/ротировать; отдельный security-lane                                                                                  | канон §11.1                                                                                     |
...
4. **Security-lane** — FE-D9 (`logApiError` секреты, HIGH) — ✅ выполнено 2026-09-02 (PR #TBD, артефакт `debt-fe-d9-redact-logger.md`) + SEC-DOC-1 (plaintext-креды в docs) — остаётся; lane рекомендуется первым.
