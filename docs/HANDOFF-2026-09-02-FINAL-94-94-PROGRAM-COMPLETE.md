...
4. **Security-lane** — FE-D9 (`logApiError` секреты, HIGH) — ✅ выполнено 2026-09-02 (PR #382, артефакт `debt-fe-d9-redact-logger.md`) + SEC-DOC-1 (plaintext-креды в docs) — остаётся; lane рекомендуется первым.
