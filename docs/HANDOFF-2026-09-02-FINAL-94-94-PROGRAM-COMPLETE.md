...
| **FE-D9**                   | open — **HIGH security** | `logApiError` пишет не-2xx тела вкл. секреты                                                                                                                                                                                                                    | redact-логгер; выделенная security-lane                                                                                        | канон §11.1                                                                                     |
...
4. **Security-lane** — FE-D9 (`logApiError` секреты, HIGH) + SEC-DOC-1 (plaintext-креды в docs); рекомендуется первым.
