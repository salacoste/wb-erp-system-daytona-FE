...
|---|---|---|
| **boundary 459→401 owner-sweep** — волна-1 ✅ (2026-09-02, сессия-2, PR — см. артефакт) | каталог `_bmad-output/planning-artifacts/shadcn-ui-boundary-classification-manifest.md` (per-route counts) | финансовая family (11 файлов/58 сайтов) замкнута с WCAG-харнессом и house-rule (артефакт `debt-p2-boundary-wave1-finsum.md`); волны 2-6 остатка 401: Margin-семейство, SourceBadge, lib-residue; ratchet ↓ тем же коммитом |
