...
#### D-1 — PB-1: silent cabinet-create (приоритет 1 из оставшихся)
...
| **/10-family ASB** (новый residual PR #384) | `AcceptanceStatusBadge.tsx:45-48` — success /10 = **4.49:1**, warning /10 = **4.24:1** light (dark ≥7.1 ok) | те же solid-пары; дёшево |
