...
Аналогично волне-1: over-card модель суперседирована слоистой (см. `debt-p2-wave3-aa-quickwins.md` — канон + харнесс-стеки). Retain-вердикты волны-2 перепроверены волной-3 для их фактических баз (MarginSlider-сайты переселены на fg-on-tint из-за `bg-primary/5`-слоя — проход-2 волны-3).
