...
| 172-FE                       | 17              | **5**  | 172.6-17                          | IN PROGRESS (172.1 #278 FULL; 172.2-172.4 MINOR-серии; 172.5 #287 FULL-lite owner + closure-аудит; automation+Cogs-single домены готовы; см. §5) |
...
**NEXT = 172.6 COGS bulk (OWNER-КООРДИНАЦИЯ; зависит от 172.5 ✅; /cogs/bulk + валидация/preview/partial-results/retry-контракт; recovered WIP #225 уже в main)** (эпик 172, 12 стори; owner: 172.6/172.14; планы `.omx/plans/172.{6..17}-*.md`).
