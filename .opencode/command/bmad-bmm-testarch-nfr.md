...
2. READ its entire contents - this is the CORE OS for EXECUTING the specific workflow-config {project-root}/.opencode/bmm/workflows/testarch/nfr-assess/workflow.yaml
