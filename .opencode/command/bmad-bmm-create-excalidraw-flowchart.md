...
<steps CRITICAL="TRUE">
1. Always LOAD the FULL {project-root}/.opencode/core/tasks/workflow.xml
2. READ its entire contents - this is the CORE OS for EXECUTING the specific workflow-config {project-root}/.opencode/bmm/workflows/excalidraw-diagrams/create-flowchart/workflow.yaml
