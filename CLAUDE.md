...
| UI boundary | `node scripts/check-shadcn-ui-boundary.mjs` | 57 = ratchet baseline (exit 1 only on increase; ↓57 lib-hex → semantic tokens, 2026-09-11 C5-W2; ↓4 dead lib/chart-colors.ts removed, 2026-09-11 C5-W1; was 118 after wave-5 ↓149, 2026-09-05 P2; 267 after wave-4 ↓105; residue = 38 chart-hex + 19 legacy-palette classes: components 37 + app 17 + types 3, owned by C5 waves-3..4) |
