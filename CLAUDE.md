...
**Disposition language is normative, not aspirational.** Triggers state "≥3 passes" / "MANDATORY 3rd-pass" / "MANDATORY 4th-pass" — explicitly NOT "recommended" or "optional". Coordinator MUST run the additional pass(es) before Status flip; reviewer MUST hunt with full adversarial intent even when finding density is high.
