...
| Vitest | `npm test -- --run` | ≥ 19464 passing / 0 failed (floor: 19118 after 174.2 dead-test deletion; +237 from 174.3 window; +8 contract tests 174.4; +52 redact suite debt-FE-D9; +6 nonce-mint suite D-1/PB-1; +3 urgency-tier suite C15; +12 reactive-refresh suite D-2/PB-3; +3 wave-3 AA re-pins; +9 /80-sweep style pins; +16 FE-D3 sanitizer pins) |
