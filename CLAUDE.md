...
| Dot-locale percent | `bash scripts/check-locale-percent.sh` | 20 (ratchet ↓; lower `.locale-percent-baseline.txt` when migrating OR exempting; started at ~108 in iter-67) |
