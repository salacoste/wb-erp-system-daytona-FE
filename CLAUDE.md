...
| UI boundary | `node scripts/check-shadcn-ui-boundary.mjs` | 114 = ratchet baseline (exit 1 only on increase; ↓4 dead lib/chart-colors.ts removed, 2026-09-11 C5-W1; was 118 after wave-5 ↓149, 2026-09-05 P2; 267 after wave-4 ↓105; residue = 91 chart-hex + 23 legacy-palette classes: lib 57 + components 37 + app 17 + types 3, owned by C5 waves-2..4) |
