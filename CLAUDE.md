...
| UI boundary | `node scripts/check-shadcn-ui-boundary.mjs` | 372 = ratchet baseline (exit 1 only on increase; ↓29 Margin family wave-2 + D-4 /15→/5 fold-in, 2026-09-03 P2; was 401 after wave-1 ↓58) |
