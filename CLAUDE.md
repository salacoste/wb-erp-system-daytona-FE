...
| UI boundary | `node scripts/check-shadcn-ui-boundary.mjs` | 267 = ratchet baseline (exit 1 only on increase; ↓105 component families wave-4, 2026-09-05 P2; was 372 after wave-2 ↓29; chart-hex residue 37 in components deferred to C5-owner) |
