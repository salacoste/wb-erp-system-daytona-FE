...
| Vitest | `npm test -- --run` | ≥ 19573 passing / 0 failed (floor: 19118 after 174.2 dead-test deletion; +237 from 174.3 window; +8 contract tests 174.4; +52 redact suite debt-FE-D9; +6 nonce-mint suite D-1/PB-1; +3 urgency-tier suite C15; +12 reactive-refresh suite D-2/PB-3; +3 wave-3 AA re-pins; +9 /80-sweep style pins; +16 FE-D3 sanitizer pins; +28 FE-D1 retry/ApiError-preservation pins; +29 FE-D5 web-locks/claim suite; +16 fe-d3-family hook-fallback pins; +22 wave-6 WCAG style pins; +11 route-guards exact-array pins, session-9; +3 C5-W1 token-contract/stack pins) |
| UI boundary | `node scripts/check-shadcn-ui-boundary.mjs` | 0 = ratchet baseline (exit 1 only on increase; ↓57 presentation components/app/types → tokens, 2026-09-11 C5-W3; ↓57 lib-hex C5-W2; ↓4 dead chart-colors C5-W1; was 118 after wave-5 ↓149, 267 after wave-4 ↓105; 0 live sites — 3 registered exceptions suppress legacy matches (waterfall C5 + 2 historical #7C3AED), lifted+migrated at C5-W4) |
