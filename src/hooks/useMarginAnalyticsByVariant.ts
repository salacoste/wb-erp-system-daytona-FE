...
/** Pagination block returned by the by-variant endpoint (live-verified at the FR-7 re-pin; any week stamp goes stale on DB reseed — see debt-p3-test-epics-tranche.md). */
