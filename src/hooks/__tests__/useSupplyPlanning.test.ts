...
describe('useSupplyPlanning', () => {
  ...
  describe('loading states', () => {
    ...
    it('should respect enabled option', async () => {
      const { result } = renderHookWithClient(() => useSupplyPlanning({}, { enabled: false }))
  ...
  describe('cache behavior', () => {
    it('should cache data between renders', async () => {
      ...
      // First render
      const { result, rerender } = renderHookWithClient(() => useSupplyPlanning(params), {
        queryClient,
      })
...
describe('useStockoutRisks', () => {
  ...
  it('should fetch only stockout risk items', async () => {
    ...
    result.current.data?.data.forEach(item => {
      expect(['out_of_stock', 'critical', 'warning']).toContain(item.stockout_risk)
    })
  })
...
describe('useInvalidateSupplyPlanningQueries', () => {
  ...
  it('should invalidate queries when called', async () => {
    ...
    const { result: dataResult } = renderHookWithClient(() => useSupplyPlanning(), { queryClient })
...
describe('supplyPlanningQueryKeys', () => {
  it('should have correct structure', () => {
    ...
    expect(supplyPlanningQueryKeys.list(params)).toEqual(['supply-planning', 'list', params])
  })
})
