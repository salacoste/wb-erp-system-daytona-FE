/**
 * Unified Product Analytics — core types (Stories 120.5 + 120.6-FE).
 *
 * Tab shell, funnel, advertising, organic, and main response types.
 *
 ...
 * as number | null, counts as number.
 */
