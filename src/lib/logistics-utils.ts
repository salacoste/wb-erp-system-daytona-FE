...
// Types and cargo classification extracted for file-size compliance
export type { CargoType, AutoFillParams, AutoFillResult } from './logistics-types'
export { determineCargoType } from './logistics-types'

import { determineCargoType } from './logistics-types'
import type { AutoFillParams, AutoFillResult } from './logistics-types'
 ...
 */
export function canAutoFillForwardLogistics(params: AutoFillParams): AutoFillResult {
