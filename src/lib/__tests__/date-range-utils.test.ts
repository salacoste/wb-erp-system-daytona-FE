...
describe('getSmartAggregation', () => {
  it.skip('should return "day" for 1 day', () => {
    expect(getSmartAggregation(1)).toBe('day')
  })

  it.skip('should return "day" for 30 days', () => {
    expect(getSmartAggregation(30)).toBe('day')
  })

  it.skip('should return "day" for exactly 90 days (boundary)', () => {
    expect(getSmartAggregation(90)).toBe('day')
  })

  it.skip('should return "week" for 91 days (first week boundary)', () => {
    expect(getSmartAggregation(91)).toBe('week')
  })

  it.skip('should return "week" for 120 days', () => {
    expect(getSmartAggregation(120)).toBe('week')
  })

  it.skip('should return "week" for exactly 180 days (boundary)', () => {
    expect(getSmartAggregation(180)).toBe('week')
  })

  it.skip('should return "month" for 181 days (first month boundary)', () => {
    expect(getSmartAggregation(181)).toBe('month')
  })

  it.skip('should return "month" for 270 days', () => {
    expect(getSmartAggregation(270)).toBe('month')
  })

  it.skip('should return "month" for 365 days (max range)', () => {
    expect(getSmartAggregation(365)).toBe('month')
  })

  it.skip('should handle all aggregation test cases from fixtures', () => {
...
describe('getAggregationLabel', () => {
  it.skip('should return "Ежедневно" for day aggregation', () => {
    expect(getAggregationLabel('day')).toBe('Ежедневно')
  })

  it.skip('should return "Еженедельно" for week aggregation', () => {
    expect(getAggregationLabel('week')).toBe('Еженедельно')
  })

  it.skip('should return "Ежемесячно" for month aggregation', () => {
    expect(getAggregationLabel('month')).toBe('Ежемесячно')
  })

  it.skip('should return labels in Russian for all aggregation levels', () => {
  ...
  it.skip('should have consistent labels with aggregation test cases', () => {
...
describe('formatDateRu', () => {
  it.skip('should format date as DD.MM.YYYY', () => {
    const date = new Date('2025-01-29')
    expect(formatDateRu(date)).toBe('29.01.2025')
  })

  it.skip('should pad single-digit day with zero', () => {
    const date = new Date('2025-01-05')
    expect(formatDateRu(date)).toBe('05.01.2025')
  })

  it.skip('should pad single-digit month with zero', () => {
  ...
  it.skip('should handle leap year date (Feb 29)', () => {
    const date = new Date('2024-02-29')
    expect(formatDateRu(date)).toBe('29.02.2024')
  })

  it.skip('should handle first day of year', () => {
    const date = new Date('2025-01-01')
    expect(formatDateRu(date)).toBe('01.01.2025')
  })

  it.skip('should handle all date formatting test cases from fixtures', () => {
    dateFormattingTestCases.forEach(({ date, expected }) => {
      expect(formatDateRu(date)).toBe(expected)
    })
  })

  it.skip('should use Russian locale (not affected by system locale)', () => {
...
describe('pluralizeDays', () => {
  describe('singular form "день"', () => {
    it.skip('should return "день" for 1', () => {
      expect(pluralizeDays(1)).toBe('день')
    })

    it.skip('should return "день" for 21', () => {
      expect(pluralizeDays(21)).toBe('день')
    })

    it.skip('should return "день" for 31', () => {
      expect(pluralizeDays(31)).toBe('день')
    })

    it.skip('should return "день" for 101', () => {
      expect(pluralizeDays(101)).toBe('день')
    })
  })

  describe('genitive singular "дня" (2-4)', () => {
    it.skip('should return "дня" for 2', () => {
      expect(pluralizeDays(2)).toBe('дня')
    })

    it.skip('should return "дня" for 3', () => {
      expect(pluralizeDays(3)).toBe('дня')
    })

    it.skip('should return "дня" for 4', () => {
      expect(pluralizeDays(4)).toBe('дня')
    })

    it.skip('should return "дня" for 22, 23, 24', () => {
  ...
  describe('genitive plural "дней" (5-20, 25-30)', () => {
    it.skip('should return "дней" for 5-10', () => {
      for (let i = 5; i <= 10; i++) {
        expect(pluralizeDays(i)).toBe('дней')
      }
    })

    it.skip('should return "дней" for 11-19 (special case)', () => {
      for (let i = 11; i <= 19; i++) {
        expect(pluralizeDays(i)).toBe('дней')
      }
    })

    it.skip('should return "дней" for 20', () => {
      expect(pluralizeDays(20)).toBe('дней')
    })

    it.skip('should return "дней" for 25-30', () => {
      for (let i = 25; i <= 30; i++) {
        expect(pluralizeDays(i)).toBe('дней')
      }
    })
  ...
  describe('edge cases', () => {
    it.skip('should return "дней" for 100', () => {
      expect(pluralizeDays(100)).toBe('дней')
    })

    it.skip('should return "дней" for 111-119 (special 11-19 rule)', () => {
      for (let i = 111; i <= 119; i++) {
        expect(pluralizeDays(i)).toBe('дней')
      }
    })

    it.skip('should return "дней" for 365', () => {
      expect(pluralizeDays(365)).toBe('дней')
    })

    it.skip('should handle all pluralization test cases from fixtures', () => {
...
describe('isRangeValid', () => {
  ...
  describe('custom maxDays', () => {
    it.skip('should respect custom maxDays parameter', () => {
...
describe('getPresetRange', () => {
  ...
  it.skip('should return range for 30 days preset', () => {
...
describe('calculateDaysDiff', () => {
  ...
  it.skip('should handle leap year correctly', () => {
