/**
 * Unified Product Analytics Boundary Normalizer — Story 120.6-FE.
 *
 * Absorbs backend shape drift for GET /v1/analytics/product/:nmId/unified.
 ...
 *
 * Grain note: funnel totals come from the latest-synced representative row
 * (NOT sum of daily replicas). The normalizer trusts the backend totals shape
 * as-is — it does NOT re-aggregate dates.
 */
