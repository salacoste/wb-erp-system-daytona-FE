 ...
 * are shared per plan; src/lib is forbidden). Catalog pinned (30 route prod
...
describe('Story 172.12 monitoring presentation source contracts', () => {
  it('catalog pinned (30 route files, per-file identity)', () => {
    ...
    const expected = [
      ...
      'components/SearchAnalyticsStatusCard.tsx',
