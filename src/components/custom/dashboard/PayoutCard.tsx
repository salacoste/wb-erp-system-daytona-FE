          ...
          <Tooltip>
            ...
            <TooltipContent size="lg">
              <p style={{ whiteSpace: 'pre-line' }}>
                {
                  'Итоговая сумма, которую WB перечислит на ваш расчётный счёт.\nФормула: Выкупы − Возвраты − Комиссия − Логистика − Хранение − Штрафы − Прочие удержания.\nЭто «денежный поток» от WB до вычета ваших собственных расходов (себестоимость, налоги).\nДля расчёта реальной прибыли смотрите карточки «Операционная прибыль» и «Чистая прибыль».\nИсточник: еженедельный финансовый отчёт WB (поле payout_total).'
                }
              </p>
            </TooltipContent>
          </Tooltip>
