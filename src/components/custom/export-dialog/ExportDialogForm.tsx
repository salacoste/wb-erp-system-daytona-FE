 ...
 *
 * Configuration form for export parameters: type, date range, format, COGS toggle.
 */
...
import { EXPORT_TYPE_LABELS } from './export-dialog-constants'
...
interface ExportDialogFormProps {
  ...
  includeCogs: boolean
  onIncludeCogsChange: (checked: boolean) => void
  createError: Error | null
}

export function ExportDialogForm({
  type,
  onTypeChange,
  weekStart,
  weekEnd,
  ...
  return (
    <div className="space-y-5 py-4">
      ...
      <div className="flex items-center space-x-2">
        ...
        />
        <Label htmlFor="include-cogs" className="text-sm font-normal cursor-pointer">
