/**
 * MSW Query Handlers for Liquidity Analysis API
 * Epic 7 - Liquidity Analysis (Ликвидность товаров)
 * Story 7.1: API Integration
 *
 * Mock data generators and GET handlers for testing liquidity hooks and components
 */
...
export const liquidityQueryHandlers = [
