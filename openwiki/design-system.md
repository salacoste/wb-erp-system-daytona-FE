...
The foundation above is the first phase of a 94-story, 76-route migration defined in (status snapshot 2026-08-30: **87 of 94 canonical stories complete**, recorded Vitest floor 19,733/0 across 1,249 files — unchanged by Story 173.11, which ran focused 112/112 plus immutable contracts 23/23 but no full-suite snapshot):
...
- `_bmad-output/planning-artifacts/shadcn-migration-status-and-debt-registry.md` — rolling status/debt snapshot of the migration waves (snapshot 2026-08-30: **Epics 166–172 are closed** — 172 at 17/17 — and Stories 173.1–173.11 are done, so Epic 173 is 11/13 with **NEXT = 173.12** and 87 of 94 canonical stories done; the recorded Vitest floor is 19,733/0 across 1,249 files; per-story status lives in `_bmad-output/implementation-artifacts/sprint-status.yaml` and is summarized on [Migration Program](migration-program.md)).
...
Per `_bmad-output/planning-artifacts/shadcn-migration-status-and-debt-registry.md` (snapshot 2026-08-30: Epics 166–172 closed, Epic 173 at 11/13; per-story status is summarized on [Migration Program](migration-program.md)):

| Debt | Owner / due |
|------|-------------|
| Epic 173 remainder: 173.12–173.13 supplies (NEXT = 173.12 after the Story 173.11 documentation lifecycle merges and cleans) | Current lane |
