...
- Epic 127: done.
- Epic 162: done.
- Epics 163 and 164: done.
- Epic 165: 165.1-165.3 done; 165.4 and 165.5 deferred (backend-gated).

## Required Repairs on the Next Update

- `openwiki/quickstart.md` and/or `openwiki/index.md` MUST contain a visible **Current Delivery Status** section with bullets for these exact truths: Epic 127 is done; Epic 162 is done; Epics 163 and 164 are done; Epic 165 — stories 165.1-165.3 are done and 165.4/165.5 are deferred (backend-gated).
