...
- **Process**: Install OpenWiki globally → `openwiki code --update --print` → auto-creates PR via `peter-evans/create-pull-request@v7` updating `openwiki/`, `AGENTS.md`, `CLAUDE.md`, and the workflow itself
