...
- [Testing & Operations](testing-and-ops.md) - Testing strategy (Vitest unit with MSW, Playwright E2E, governed coverage certification, Tier 0 runtime certification), test organization and fixtures, CI/CD workflows, PM2 deployment, and environment variables.
