...
- [Testing & Operations](testing-and-ops.md) - Testing strategy (Vitest unit with MSW, Playwright E2E, privacy console check), test organization and fixtures, CI/CD workflows, local run modes, and environment variables.
