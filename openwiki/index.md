...
- [Testing & Operations](testing-and-ops.md) - Testing strategy (Vitest unit with MSW, Playwright E2E, outbound network guards, Playwright static boundary, privacy console and diagnostic-capture guards, frontend verification orchestrator), CI/CD workflows, local run modes, and environment variables.
