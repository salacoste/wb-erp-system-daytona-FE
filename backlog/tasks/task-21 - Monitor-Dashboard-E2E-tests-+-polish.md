...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 E2E spec passes with domcontentloaded pattern
- [ ] #2 axe-core zero critical violations
- [ ] #3 All 5 blocks render independently (partial failure OK)
- [ ] #4 Auto-refresh configurable
- [ ] #5 npm run type-check && npm run lint && npm test pass
<!-- AC:END -->
