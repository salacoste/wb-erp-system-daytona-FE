...
- [x] #1 FinanceDailyData includes advertisingSpend + netProfit (number | null)
- [x] #2 Client-side calculateDailyTheoreticalProfit retired or used only as fallback
- [x] #3 Daily table shows backend netProfit (not client calc)
- [x] #4 New 'Реклама' row in daily breakdown using advertisingSpend
- [x] #5 Null handling per CLAUDE.md anti-pattern #8

- [x] #6 npm run type-check && npm run lint && npm test pass
<!-- AC:END -->
