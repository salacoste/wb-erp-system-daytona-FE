...
- [x] #1 Buyout rate displays with color coding
- [x] #2 Pipeline health shows last recalc time
- [x] #3 Unhealthy pipelines listed with status badges
- [x] #4 Relative time formatting (e.g. '2 часа назад')
- [x] #5 Loading + error states for both blocks
<!-- AC:END -->
