...
- [x] #1 Request #166 doc updated with actual response shapes
- [x] #2 Epic 90 planning artifact BLOCKED status removed
- [x] #3 Sprint-status.yaml Epic 90 stories unchanged (full scope)
- [x] #4 test-api/34-acquiring-analytics.http confirmed present
<!-- AC:END -->
