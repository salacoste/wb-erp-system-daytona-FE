...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 4 KPI cards render with real data
- [ ] #2 Color coding on COGS coverage % card
- [ ] #3 Loading skeletons during fetch
- [ ] #4 Route registered + sidebar entry added
- [ ] #5 WCAG 2.1 AA accessible (aria-labels on cards)
<!-- AC:END -->
